...
<legend>{$descripcion}</legend>
  <table class="datos">
    ...
    <tr>
      <td>Material:</td>
      <td>{if empty($material_name)}No disponible{else}{$material_name}{/if}</td>
    </tr>
    <tr><tr>
      <td>Autor:</td>
      <td>{if empty($autor_name)}No disponible{else}{$autor_name}{/if}</td>
    </tr><tr>
      <td>Ciudad:</td>
      <td>{if empty($ciudad_name)}No disponible{else}{$ciudad_name}{/if}</td>
    </tr><tr>
      <td>Proyecto:</td>
      <td>{if empty($proyecto_name)}No disponible{else}{$proyecto_name}{/if}</td>
    </tr>
    </tr><tr>
      <td>Categoria:</td>
      <td>{if empty($proyecto_name)}No disponible{else}{$categoria_name}{/if}</td>
    </tr>
    <tr>
